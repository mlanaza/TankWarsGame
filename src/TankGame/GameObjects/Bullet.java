...
public class Bullet extends Weapon {
    ...
    Bullet(BufferedImage wpn, int x, int y, int vx, int vy, int angle, Tank t1, GameWorld game){
        this.wpn = wpn;
        this.x = x;
        this.y = y;
        this.vx = vx;
   ...
   void checkWalls(){
        ...
        for(int i = 0; i<tileMap.size(); i++ ){
            ...
            if(this.IntersectsWall){
                ...
                switch(num){
                    ...
                    case 1:
                        this.game.getMap().setTileNum(row,col, 3);
                        break;
                    case 3:
    ...
    public void render(Graphics g){
        ...
        bullet.rotate(Math.toRadians(angle), this.wpn.getWidth() / 2, this.wpn.getHeight() /2);
